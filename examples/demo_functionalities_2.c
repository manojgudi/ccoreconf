...
void main() {
    ...
    */
    ...
    /*
    // Get the healthValue where readingIndex is 2
    json_t* healthValueJSONInstance = get_healthValue(coreconfModel, sidModel, 1);
    printf("Obtained the healthValue: \n");
    print_json_object(healthValueJSONInstance);
    printf("---------\n");
*/
