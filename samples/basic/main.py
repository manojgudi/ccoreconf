...
absolutePath = "/home/valentina/projects/lpwan_examples/pycoreconf/samples/basic/"
ccm = pycoreconf.CORECONFModel(absolutePath + "example-1@unknown.sid")

# Read JSON configuration file
config_file = absolutePath + "ex1-config.json"
#config_file = absolutePath + "example-1.yang"
